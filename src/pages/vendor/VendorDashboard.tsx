...
export function VendorDashboard() {
    ...
    const totalProducts = productsLoading ? 'Loading...' : (products?.data.length ?? 0);
    ...
    return (
        <div className="p-4 md:p-6">
            <h1 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6">Vendor Dashboard</h1>
            ...
            <div className="mb-8">
                <h2 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6">Statistics</h2>
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-6 mb-4 md:mb-8">
                    <div className="w-full md:w-1/2 lg:w-1/3 bg-white p-4 md:p-6 shadow-lg rounded-lg">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Order Status</h3>
                    ...
                    <div className="w-full md:w-1/2 lg:w-2/3 bg-white p-4 md:p-6 shadow-lg rounded-lg">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Product Inventory</h3>
                ...
                <div className="mb-4 md:mb-8">
                    <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Detailed Statistics</h3>
                        <Table
                            data={[
                    ...
                    <h3 className="text-lg md:text-xl font-semibold mb-2">Product Inventory</h3>
                    <Table<IProduct>
                        data={products?.data ?? []}
                        columns={[
